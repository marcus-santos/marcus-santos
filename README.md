...
<p align="center">🚀 Full Stack Developer | 🎓 Computer Science Student @ IFSP</p>

---

### 👨‍💻 About Me

I'm a passionate developer currently studying Computer Science at the Federal Institute of São Paulo (IFSP).  
I love exploring both front-end and back-end development, and I'm especially driven by meaningful, community-focused projects.

I’ve worked on:
- 🛠️ **Arteiros Caraguá** – a social e-commerce for local artisans (front-end with Next.js and shadcn/ui)
- 📦 **StockBox** – an academic inventory system focused on sustainability (documentation lead)
- 💡 Various academic exercises and algorithm implementations in **Java**, **Python**, and **C++**
